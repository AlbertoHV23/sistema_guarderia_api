            ...
            @endif
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                            ...
                            <input type="text" class="form-control" id="name" value="" name="name" placeholder="Nombre(s)"
                                required>
                        </div>
                        ...
                        <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                            ...
                            <input type="file" class="form-control" id="imagen" value="" accept=".jpeg,.jpg,.png"
                                name="imagen" placeholder="Imagen de la noticia">
                        ...
                        <div class="mb-3 col-sm- col-mb-6 col-xl-6 ">
                            ...
                            <select name="rol_id" class="form-control" id="rol_id" required>
                                ...
                                @foreach ($data as $d)
                                    <option class="text-black" value="{{ $d->id }}">{{ $d->role }}</option>
                                @endforeach
                            </select>
                        </div>
                        <br>
